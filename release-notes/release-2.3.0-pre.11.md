% Enyo 2.3.0-pre.11 Release Notes

Welcome to Enyo 2.3.0-pre.11, a pre-release version of Enyo 2.3.0.  The
...
* In `enyo.Collection`, updated `add()` to fix issue preventing records from
    being added at index 0.
